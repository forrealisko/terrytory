...
const STAGE_META = [
  { key: "scraped", label: "Scraped", href: "/admin", color: "#38bdf8", sub: (s: Stages) => `${s.scrapedNew} new this run` },
  ...
  { key: "published", label: "Published", href: "/admin/content/published", color: "#4f8dfd", sub: () => "live on the blog" },
] as const;
